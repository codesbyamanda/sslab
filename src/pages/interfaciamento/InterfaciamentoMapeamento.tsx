  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-2 text-sm text-muted-foreground">
        ...
        <span className="text-foreground">Mapeamento de Exames</span>
      </div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="flex flex-wrap gap-4">
            ...
            <Button 
              variant="outline" 
              onClick={() => { setFiltroExame(""); setFiltroEquipamento("todos"); }}
            >
              Limpar
            </Button>
          </div>
              ...
              {mapeamentosFiltrados.length === 0 ? (
                ...
                mapeamentosFiltrados.map((mapeamento) => (
                  <TableRow key={mapeamento.id}>
                    ...
                    <TableCell>
                      <Badge 
                        className={mapeamento.status === "ativo" 
            ...
            <div className="space-y-4 py-4">
              ...
              <div>
                ...
                <Input
                  ...
                  value={codigoEquipamentoEdit}
                  onChange={(e) => setCodigoEquipamentoEdit(e.target.value)}
                  placeholder="Código usado pelo equipamento"
                />

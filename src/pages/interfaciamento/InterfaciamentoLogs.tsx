...
import { Filter, FileText, ChevronRight, Home, Eye, CheckCircle2, XCircle, AlertTriangle } from "lucide-react";
const logs = [{
  id: 1,
      ...
      <Card>
        <CardContent className="p-0">
          <Table>
            ...
            <TableBody>
              {logsFiltrados.length === 0 ? <TableRow>
                  <TableCell colSpan={6} className="text-center py-12">
                    <FileText className="w-12 h-12 mx-auto mb-3 text-muted-foreground/30" />
                    <p className="text-muted-foreground">Nenhum log encontrado</p>
                  </TableCell>
                </TableRow> : logsFiltrados.map(log => <TableRow key={log.id}>

...
import { Filter, Activity, ChevronRight, Home, ArrowUp, ArrowDown, CheckCircle2, XCircle, RefreshCw, Clock } from "lucide-react";
const comunicacoes = [{
  id: 1,
      ...
      <Card>
        <CardContent className="p-0">
          <Table>
            ...
            <TableBody>
              {comunicacoesFiltradas.length === 0 ? <TableRow>
                  <TableCell colSpan={7} className="text-center py-12">
                ...
                </TableRow> : comunicacoesFiltradas.map(comunicacao => <TableRow key={comunicacao.id}>
                    <TableCell className="font-mono text-sm">{comunicacao.dataHora}</TableCell>
                    <TableCell>{comunicacao.equipamento}</TableCell>
                    <TableCell>
                      <div className="flex items-center gap-2">
                        {comunicacao.tipo === "Envio" ? <ArrowUp className="w-4 h-4 text-green-600" /> : <ArrowDown className="w-4 h-4 text-blue-600" />}
                    ...
                    <TableCell>
                      {comunicacao.status === "sucesso" ? <Badge className="bg-green-100 text-green-700 hover:bg-green-100">

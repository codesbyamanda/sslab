...
import { Plus, Search, Filter, Eye, Cable, ChevronRight, Home, ArrowUpDown, ArrowUp, ArrowDown } from "lucide-react";
const protocolos = [{
  id: 1,
  nome: "ASTM E1381",
  tipo: "ASTM",
          ...
          <div className="flex flex-wrap gap-4">
            <div className="flex-1 min-w-[250px]">
              <div className="relative">
                ...
                <Input placeholder="Buscar por nome do protocolo..." value={filtroNome} onChange={e => setFiltroNome(e.target.value)} className="pl-10" />
              </div>
            </div>
      ...
      <Card>
        <CardContent className="p-0">
          <Table>
            ...
            <TableBody>
              {protocolosFiltrados.length === 0 ? <TableRow>
                  <TableCell colSpan={6} className="text-center py-12">
                ...
                </TableRow> : protocolosFiltrados.map(protocolo => <TableRow key={protocolo.id}>
                    ...
                    <TableCell>
                      <Badge className={protocolo.status === "ativo" ? "bg-green-100 text-green-700 hover:bg-green-100" : "bg-gray-100 text-gray-700"}>

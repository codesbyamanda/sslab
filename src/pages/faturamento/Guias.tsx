...
const mockGuias = [
  { 
    ...
    servicos: [
      { codigo: "40301630", nome: "Hemograma completo", valor: 25.00 },
      { codigo: "40302040", nome: "Glicose", valor: 15.00 },
      { codigo: "40301117", nome: "TSH", valor: 45.00 },
      { codigo: "40301125", nome: "T4 Livre", valor: 45.00 },
    ],
    historico: [
      { data: "2024-01-15 08:30", usuario: "Maria Silva", acao: "Guia criada" },
      { data: "2024-01-15 09:15", usuario: "João Santos", acao: "Serviços adicionados" },
    ]
  },
  { 
    id: 2, 
    ...
    historico: [
      { data: "2024-01-15 10:00", usuario: "Ana Costa", acao: "Guia criada" },
      { data: "2024-01-15 10:30", usuario: "Sistema", acao: "Pendência detectada: CID ausente" },
    ]
  },
  { 
    id: 3, 
    ...
    servicos: [
      { codigo: "40302040", nome: "Glicose", valor: 15.00 },
      { codigo: "40302059", nome: "Colesterol total", valor: 18.00 },
    ],
    historico: [
      { data: "2024-01-14 14:00", usuario: "Pedro Lima", acao: "Guia criada" },
    ]
  },
  { 
    id: 4, 
    ...
    historico: [
      { data: "2024-01-14 09:00", usuario: "Carla Dias", acao: "Guia criada" },
      { data: "2024-01-14 09:30", usuario: "Sistema", acao: "Pendências detectadas" },
    ]
  },
  { 
    id: 5, 
    ...
    historico: [
      { data: "2024-01-13 11:00", usuario: "Maria Silva", acao: "Guia criada" },
      { data: "2024-01-13 14:00", usuario: "João Santos", acao: "Guia cancelada - Solicitação do paciente" },
    ]
  },
  { 
    id: 6, 
    ...
    historico: [
      { data: "2024-01-13 08:00", usuario: "Ana Costa", acao: "Guia criada" },
      { data: "2024-01-14 10:00", usuario: "Pedro Lima", acao: "Guia incluída no lote PF-2024-001" },
      { data: "2024-01-15 09:00", usuario: "Carla Dias", acao: "Guia faturada - Lote FAT-2024-001" },
    ]
  },
  { 
    id: 7, 
    ...
    historico: [
      { data: "2024-01-12 16:00", usuario: "Maria Silva", acao: "Guia criada" },
      { data: "2024-01-12 16:30", usuario: "Sistema", acao: "Pendência: Procedimento não autorizado" },
    ]
  },
  { 
    id: 8, 
    ...
    historico: [
      { data: "2024-01-12 10:00", usuario: "João Santos", acao: "Guia criada" },
    ]
  },
];
  ...
  const confirmCancelGuia = () => {
    ...
    setGuias(prev => prev.map(g => 
      g.id === selectedGuia.id 
        ? { ...g, status: "cancelada" as GuiaStatus }
        : g
    ));
        ...
        <main className="flex-1 p-6 overflow-auto">
          ...
          <div className="space-y-6 animate-fade-in">
            ...
            <div className="bg-card rounded-xl border border-border/50 shadow-sm">
              ...
              {/* Table */}
              {hasFiltered && !isLoading && guias.length > 0 && (
                          ...
                          <TableCell className="text-center" onClick={(e) => e.stopPropagation()}>
                            <DropdownMenu>
                              ...
                              <DropdownMenuContent align="end" className="bg-card border-border">
                                ...
                                <DropdownMenuSeparator />
                                <DropdownMenuItem 
                                  onClick={() => handleCancelGuia(guia)}
                                  disabled={guia.status === "faturada" || guia.status === "cancelada"}
                                  className={cn(
                                    guia.status !== "faturada" && guia.status !== "cancelada" && "text-vermelho-moderno focus:text-vermelho-moderno"
                                  )}
                                >
              ...
              <div className="space-y-4">
                ...
                <ScrollArea className="h-32">
                  <div className="space-y-2">
                    {selectedGuia.servicos.map((servico, idx) => (
                      <div key={idx} className="flex items-center justify-between text-sm p-2 bg-muted/30 rounded-lg">
                        ...
                        <p className="font-medium">{servico.valor.toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' })}</p>
                      </div>
                    ))}
                  </div>
                </ScrollArea>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between p-3 bg-primary/5 rounded-lg">
                  ...
                  <span className="text-lg font-bold text-primary">
                    {selectedGuia.valor.toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' })}
                  </span>
                </div>
              </div>
      ...
      <Dialog open={showHistoricoModal} onOpenChange={setShowHistoricoModal}>
        <DialogContent className="max-w-lg">
          ...
          {selectedGuia && (
            <div className="py-4">
              <div className="space-y-4">
                {selectedGuia.historico.map((item, idx) => (
                  <div key={idx} className="flex gap-3">
                    <div className="flex flex-col items-center">
                      <div className="w-2 h-2 rounded-full bg-primary" />
                      {idx < selectedGuia.historico.length - 1 && (

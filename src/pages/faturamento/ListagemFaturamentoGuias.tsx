...
const LoteFaturamentoBadge = ({ status }: { status: LoteFaturamentoStatus }) => {
...
const eventoConfig: Record<HistoricoEvento['tipo'], { icon: React.ComponentType<{ className?: string }>; color: string }> = {
  ...
  glosa_aceita: { icon: CheckCircle2, color: "text-muted-foreground" },
  glosa_reapresentada: { icon: History, color: "text-primary" },
  pendencia_identificada: { icon: AlertCircle, color: "text-amarelo-alerta" },
};
...
const mockLotes: LoteFaturamento[] = [
  { 
    ...
    valorTotal: 12580.50,
    historico: [
      { id: "1", data: "2024-01-16 08:00", usuario: "Maria Silva", tipo: "criacao", descricao: "Lote de faturamento criado" },
      { id: "2", data: "2024-01-16 08:15", usuario: "Maria Silva", tipo: "guias_incluidas", descricao: "45 guias incluídas no lote" },
      { id: "3", data: "2024-01-16 10:00", usuario: "Sistema", tipo: "arquivo_gerado", descricao: "Arquivo TISS gerado com sucesso" },
      { id: "4", data: "2024-01-17 09:00", usuario: "João Santos", tipo: "enviado_convenio", descricao: "Lote enviado ao convênio Unimed" },
      { id: "5", data: "2024-01-20 14:00", usuario: "Sistema", tipo: "fechamento", descricao: "Lote fechado após confirmação do convênio" },
    ]
  },
  { 
    id: 2, 
    ...
    valorTotal: 8450.00,
    historico: [
      { id: "1", data: "2024-01-16 09:00", usuario: "Ana Costa", tipo: "criacao", descricao: "Lote de faturamento criado" },
      { id: "2", data: "2024-01-16 09:30", usuario: "Ana Costa", tipo: "guias_incluidas", descricao: "32 guias incluídas no lote" },
      { id: "3", data: "2024-01-17 11:00", usuario: "Sistema", tipo: "arquivo_gerado", descricao: "Arquivo XML gerado" },
      { id: "4", data: "2024-01-18 08:00", usuario: "Pedro Lima", tipo: "enviado_convenio", descricao: "Lote enviado ao Bradesco Saúde" },
      { id: "5", data: "2024-01-22 10:00", usuario: "Sistema", tipo: "glosa_identificada", descricao: "2 itens glosados identificados", detalhes: "Procedimentos duplicados" },
    ]
  },
  { 
    id: 3, 
    ...
    valorTotal: 6320.75,
    historico: [
      { id: "1", data: "2024-01-21 08:00", usuario: "Carla Dias", tipo: "criacao", descricao: "Lote de faturamento criado" },
      { id: "2", data: "2024-01-21 08:45", usuario: "Carla Dias", tipo: "guias_incluidas", descricao: "28 guias incluídas no lote" },
      { id: "3", data: "2024-01-21 14:00", usuario: "Sistema", tipo: "pendencia_identificada", descricao: "1 guia com pendência", detalhes: "CID não preenchido" },
      { id: "4", data: "2024-01-22 09:00", usuario: "Sistema", tipo: "arquivo_gerado", descricao: "Arquivo TISS gerado" },
    ]
  },
  { 
    id: 4, 
    ...
    valorTotal: 3890.00,
    historico: [
      { id: "1", data: "2024-01-26 10:00", usuario: "Roberto Lima", tipo: "criacao", descricao: "Lote de faturamento criado" },
      { id: "2", data: "2024-01-26 10:30", usuario: "Roberto Lima", tipo: "guias_incluidas", descricao: "15 guias incluídas no lote" },
    ]
  },
  { 
    id: 5, 
    ...
    valorTotal: 14250.25,
    historico: [
      { id: "1", data: "2024-02-01 08:00", usuario: "Fernanda Dias", tipo: "criacao", descricao: "Lote de faturamento criado" },
      { id: "2", data: "2024-02-01 09:00", usuario: "Fernanda Dias", tipo: "guias_incluidas", descricao: "52 guias incluídas no lote" },
      { id: "3", data: "2024-02-01 10:00", usuario: "Sistema", tipo: "glosa_identificada", descricao: "3 itens com glosa total identificados" },
    ]
  },
];
              ...
              <div className="p-5 border-b border-border/50 bg-muted/20">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4">
                  <div className="space-y-1.5">
                    ...
                    <Input 
                      type="date" 
                      value={filterDataGeracaoInicio}
                      onChange={(e) => setFilterDataGeracaoInicio(e.target.value)}
                  ...
                  <div className="space-y-1.5">
                    ...
                    <Input 
                      type="date" 
                      value={filterDataGeracaoFim}
                      onChange={(e) => setFilterDataGeracaoFim(e.target.value)}
                      className="h-9 bg-background"
                    />
                  </div>
                  <div className="space-y-1.5">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <Input 
                      placeholder="Ex: FAT-2024-0001" 
                      value={filterNumeroFatura}
                      onChange={(e) => setFilterNumeroFatura(e.target.value)}
                      className="h-9 bg-background"
                    />
                  </div>
                  <div className="space-y-1.5">
                ...
                <TableBody>
                  {isLoading ? (
                    ...
                    >
                      ...
                      <TableCell>
                        {lote.dataEnvioLote ? formatDate(lote.dataEnvioLote) : (
                      ...
                      <TableCell>
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end" className="bg-card border-border">
                            ...
                            <DropdownMenuItem 
                              onClick={() => handleViewHistorico(lote)}
                              className="gap-2 cursor-pointer"
                            >
      ...
      <Sheet open={showHistoricoSheet} onOpenChange={setShowHistoricoSheet}>
        <SheetContent className="w-[450px] sm:max-w-[450px]">
          <SheetHeader>
            ...
            <SheetDescription>
              {selectedLote && (
                <span className="font-medium text-foreground">{selectedLote.codigo}</span>
                    ...
                    return (
                      <div key={evento.id} className="relative">
                        ...
                        <div className={cn(
                          ...
                          config.color === "text-muted-foreground" && "border-muted-foreground"
                        )}>
                          <div className={cn(

...
const RelatorioMovimentacaoFinanceira = () => {
        ...
        <main className="flex-1 p-6 overflow-auto">
          ...
          <div className="mb-6">
            ...
            <p className="text-muted-foreground mt-1">
              Selecione os filtros para gerar o extrato financeiro completo do período.
            </p>
          </div>
          ...
          <Card className="border-border/50 max-w-4xl">
            ...
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                {/* Usuário / Atendente */}
                <div className="space-y-2">
                  <Label className="text-sm">Usuário / Atendente</Label>
                  <Input
          ...
          <Dialog open={showModal} onOpenChange={setShowModal}>
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>
                  Movimentação Financeira - {dataInicio && format(dataInicio, "dd/MM/yyyy")} a {dataFim && format(dataFim, "dd/MM/yyyy")}
                </DialogDescription>
              </DialogHeader>
              ...
              <div className="py-8 flex flex-col items-center justify-center">
                {isGenerating ? (
                  ...
                  <>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">relatorio_movimentacao_financeira.pdf</p>
                  </>
                ) : null}
              </div>

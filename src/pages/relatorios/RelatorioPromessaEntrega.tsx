...
const RelatorioPromessaEntrega = () => {
  ...
  const handleGerarRelatorio = () => {
    if (!dataInicio || !dataFim) {
      toast({
        ...
        description: "Informe a data inicial e final do período de promessa.",
        variant: "destructive"
      });
      return;
    }
        ...
        <main className="flex-1 p-6 overflow-auto">
          ...
          <div className="mb-6">
            ...
            <p className="text-muted-foreground mt-1">
              Selecione os filtros para gerar o relatório de controle de prazos de entrega.
            </p>
          </div>
            ...
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  <Label className="text-sm">Período Promessa - Início *</Label>
                  <Popover>
                ...
                {/* Data Fim */}
                <div className="space-y-2">
                  <Label className="text-sm">Período Promessa - Fim *</Label>
                  <Popover>
                    <PopoverTrigger asChild>
                      <Button
                        variant="outline"
                ...
                <div className="space-y-2 md:col-span-2">
                  <Label className="text-sm">Médico Solicitante</Label>
                  <Input
          ...
          <Dialog open={showModal} onOpenChange={setShowModal}>
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>
                  Promessa de Entrega - {dataInicio && format(dataInicio, "dd/MM/yyyy")} a {dataFim && format(dataFim, "dd/MM/yyyy")}
                </DialogDescription>
              </DialogHeader>
              ...
              <div className="py-8 flex flex-col items-center justify-center">
                {isGenerating ? (
                  ...
                  <>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">relatorio_promessa_entrega.pdf</p>
                  </>
                ) : null}
              </div>
...
export default RelatorioPromessaEntrega;

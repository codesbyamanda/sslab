...
const RelatorioAtendimentoConvenio = () => {
        ...
        <main className="flex-1 p-6 overflow-auto">
          ...
          <div className="mb-6">
            ...
            <p className="text-muted-foreground mt-1">
              Selecione os filtros para gerar o relatório agrupado por convênio.
            </p>
          </div>
          ...
          <Dialog open={showModal} onOpenChange={setShowModal}>
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>
                  Atendimento por Convênio - {dataInicio && format(dataInicio, "dd/MM/yyyy")} a {dataFim && format(dataFim, "dd/MM/yyyy")}
                </DialogDescription>
              </DialogHeader>
              ...
              <div className="py-8 flex flex-col items-center justify-center">
                {isGenerating ? (
                  ...
                  <>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">relatorio_atendimento_convenio.pdf</p>
                  </>
                ) : null}
              </div>
...
export default RelatorioAtendimentoConvenio;

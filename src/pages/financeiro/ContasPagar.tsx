...
const ContasPagar = () => {
  ...
  const totalAPagar = mockContas
    ...
    .reduce((acc, c) => acc + (c.valorOriginal - c.valorPago), 0);
                    ...
                    <TableHeader>
                      <TableRow className="bg-muted/50">
                        <TableHead 
                          ...
                          onClick={() => handleSort("dataLancamento")}
                        >
                    ...
                    <TableBody>
                      {filteredContas.length === 0 ? (
                        ...
                        filteredContas.map((conta) => (
                          <TableRow 
                            key={conta.id}
                            className={isVencido(conta.dataVencimento, conta.situacao) 
                          ...
                          >
                            ...
                            <TableCell>
                              <div className="flex items-center gap-2">
                                ...
                                {isVencido(conta.dataVencimento, conta.situacao) && (
